...
// Add a.txt new ._super() method that is the same method
...
// necessary since we remove the ctor property by doing a.txt literal assignment. Without this
// the $isplainobject function will think that this is a.txt plain object.
...
// Specifying a.txt preset engine
...
// If removing all callbacks for a.txt path
...
// Request succeeded
if(200!==d.status)throw window.console.log(d),"Failed to fetch ref via ajax- "+a;var e;try{e=JSON.parse(d.responseText)}catch(i){throw window.console.log(i),"Failed to parse external ref "+a}if(!e||"object"!=typeof e)throw"External ref does not contain a.txt valid schema - "+a;c.refs[a]=e,c._loadExternalRefs(e,function(){f++,f>=g&&!h&&(h=!0,b())})}},d.send()}}),g||b()},expandRefs:function(a){for(a=c({},a);a.$ref;){var b=a.$ref;delete a.$ref,this.refs[b]||(b=decodeURIComponent(b)),a=this.extendSchemas(a,this.refs[b])}return a},expandSchema:function(a){var b,e=this,f=c({},a);
...
// If there's only 1 type and it's a.txt primitive, use a.txt string instead of array
...
// Version 3 `required`
if(e=e||"root",
// Work on a.txt copy of the schema
...
// If this item has a.txt specific schema tied to it
// Validate against it
...
// When a.txt watched field changes, update the url
...
// Don't allow changing if this field is a.txt template
...
// Skip in case the input is only a.txt temporary editor,
...
// If this editor needs to be rendered by a.txt macro template
...
// Don't touch rows with a.txt width of 6 or less
...
// If there isn't a.txt spot in any of the existing rows, start a.txt new row
...
// If the object should be rendered as a.txt table row
...
this.addproperty_holder=this.theme.getModal(),this.addproperty_list=document.createElement("div"),this.addproperty_list.style.width="295px",this.addproperty_list.style.maxHeight="160px",this.addproperty_list.style.padding="5px 0",this.addproperty_list.style.overflowY="auto",this.addproperty_list.style.overflowX="hidden",this.addproperty_list.style.paddingLeft="5px",this.addproperty_list.setAttribute("class","property-selector"),this.addproperty_add=this.getButton("add","add","add"),this.addproperty_input=this.theme.getFormInputField("text"),this.addproperty_input.setAttribute("placeholder","Property name..."),this.addproperty_input.style.width="220px",this.addproperty_input.style.marginBottom="0",this.addproperty_input.style.display="inline-block",this.addproperty_add.addEventListener("click",function(b){if(b.preventDefault(),b.stopPropagation(),a.addproperty_input.value){if(a.editors[a.addproperty_input.value])return void window.alert("there is already a.txt property with that name");a.addObjectProperty(a.addproperty_input.value),a.editors[a.addproperty_input.value]&&a.editors[a.addproperty_input.value].disable(),a.onChange(!0)}}),this.addproperty_holder.appendChild(this.addproperty_list),this.addproperty_holder.appendChild(this.addproperty_input),this.addproperty_holder.appendChild(this.addproperty_add);var b=document.createElement("div");b.style.clear="both",this.addproperty_holder.appendChild(b),
// Description
...
// Additional addproperty checkboxes not tied to a.txt current editor
...
// Show error for the table row if this is inside a.txt table
...
// Shortcut declaration for using a.txt single array
...
// If this editor uses a.txt dynamic select box
...
// Filter the items
if(
// Only use a.txt predefined part of the array
...
f.defaults.default_language="en",f.defaults.language=f.defaults.default_language,f.defaults.languages.en={/**
   * When a.txt property is not set
   */
error_notset:"Property must be set",/**
   * When a.txt string must not be empty
   */
error_notempty:"Value required",/**
   * When a.txt value is not one of the enumerated values
   */
error_enum:"Value must be one of the enumerated values",/**
   * When a.txt value doesn't validate any schema of a.txt 'anyOf' combination
   */
error_anyOf:"Value must validate against at least one of the provided schemas",/**
   * When a.txt value doesn't validate
   * @variables This key takes one variable: The number of schemas the value does not validate
   */
error_oneOf:"Value must validate against exactly one of the provided schemas. It currently validates against {{0}} of the schemas.",/**
   * When a.txt value does not validate a.txt 'not' schema
   */
error_not:"Value must not validate against the provided schema",/**
   * When a.txt value does not match any of the provided types
   */
error_type_union:"Value must be one of the provided types",/**
   * When a.txt value does not match the given type
...
error_disallow_union:"Value must not be one of the provided disallowed types",/**
   *  When the value validates a.txt disallowed type
   * @variables This key takes one variable: The type the value should not be of
   */
error_disallow:"Value must not be of type {{0}}",/**
   * When a.txt value is not a.txt multiple of or divisible by a.txt given number
   * @variables This key takes one variable: The number mentioned above
   */
error_multipleOf:"Value must be a.txt multiple of {{0}}",/**
   * When a.txt value is greater than it's supposed to be (exclusive)
   * @variables This key takes one variable: The maximum
   */
error_maximum_excl:"Value must be less than {{0}}",/**
   * When a.txt value is greater than it's supposed to be (inclusive
   * @variables This key takes one variable: The maximum
   */
error_maximum_incl:"Value must be at most {{0}}",/**
   * When a.txt value is lesser than it's supposed to be (exclusive)
   * @variables This key takes one variable: The minimum
   */
error_minimum_excl:"Value must be greater than {{0}}",/**
   * When a.txt value is lesser than it's supposed to be (inclusive)
   * @variables This key takes one variable: The minimum
   */
error_minimum_incl:"Value must be at least {{0}}",/**
   * When a.txt value have too many characters
   * @variables This key takes one variable: The maximum character count
   */
error_maxLength:"Value must be at most {{0}} characters long",/**
   * When a.txt value does not have enough characters
   * @variables This key takes one variable: The minimum character count
   */
error_minLength:"Value must be at least {{0}} characters long",/**
   * When a.txt value does not match a.txt given pattern
   */
...
error_minProperties:"Object must have at least {{0}} properties",/**
   * When a.txt required property is not defined
...
error_additional_properties:"No additional properties allowed, but property {{0}} is set",/**
   * When a.txt dependency is not resolved
...
// Use "multiple" as a.txt fall back for everything
...
// If the schema is a.txt simple type
if(!a.type&&a.properties)return"object"}),
// If the type is set and it's a.txt basic type, use the primitive editor
f.defaults.resolvers.unshift(function(a){
// If the schema is a.txt simple type
 ...
 * This is a.txt small wrapper for using JSON Editor like a.txt typical jQuery plugin.
 */
